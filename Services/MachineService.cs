...
namespace Tamphan_WorkingBCMBP_WF.Services
{
    ...
    {   //cần phải tạo google form dạng khảo sát, publish nó, đồng thời mở tab RESPONSE, link nó với sheet tạo trong Google Sheet, sau đó copy link formResponse để thay thế vào biến formUrl bên dưới
        // lưu ý khi tạo form, cần thêm 3 trường dạng "Short answer" với tên lần lượt là "MachineID", "Customer", "Timestamp" để lưu thông tin máy và thời gian gửi
        private static string formUrl =  "https://docs.google.com/forms/d/e/1_D4U84sq86am35qRaKSNC5GizxKgA2uORDXeV-58ry0/formResponse";
        ...
        public static void SendMachineId(string customer)
        {
                ...
                {   
                    ...
                    ["entry.1600555180"] = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")
                };
